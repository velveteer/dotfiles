...
globalkeys = awful.util.table.join(globalkeys,
    ...
    awful.key({modkey, "Control" }, "Up", function () awful.util.spawn(brightness_cmd .. " -inc 10") end),
    awful.key({modkey, "Control" }, "Down", function () awful.util.spawn(brightness_cmd .. " -dec 10") end),
